...
#    self.vars = {}
  ...
  def test_adminPage(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk")
    self.driver.find_element(By.ID, "password").send_keys("sdfsdfsdfsdfsdfsdfsdfsdfsfsdfsfsfsdfsfsfsfsdfssff")
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Laura")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Garda")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Locomania")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("CEO")
    value = self.driver.find_element(By.NAME, "submit").get_attribute("value")
    assert value == "Next Step"
    ...
    self.driver.find_element(By.ID, "password").send_keys("sdfsdfsdfsdfsdfsdfsdfsdfsfsdfsfsfsdfsfsfsfsdfssff")
    self.driver.find_element(By.ID, "password").send_keys("sdfsdfsdfsdfsdfsdfsdfsdfsfsdfsfsfsdfsfsfsfsdfssff")
    value = self.driver.find_element(By.CSS_SELECTOR, ".mysubmit:nth-child(4)").get_attribute("value")
    assert value == "Login"
    self.driver.find_element(By.CSS_SELECTOR, ".mysubmit:nth-child(4)").click()
    self.driver.find_element(By.CSS_SELECTOR, ".mysubmit:nth-child(4)").click()
